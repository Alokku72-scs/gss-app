...
//     const correctAnswers = question.correctAnswers;
//
//     // If the selected option is exactly the correct answer
//     if (selected.length === correctAnswers.length &&
//         correctAnswers.every(ans => selected.includes(ans))) {
//       return 4; // Full score
//     }
//
//     // If at least one correct option is selected and no incorrect options
//     if (selected.length > 0 &&
//         selected.every(sel => correctAnswers.includes(sel))) {
//       return 3; // Good score
//     }
//
//     // If at least one correct option is selected but also some incorrect ones
//     if (selected.some(sel => correctAnswers.includes(sel))) {
//       return 2; // Partial score
//     }
//
//     // If an option is selected but it's wrong
//     if (selected.length > 0) {
//       return 1; // Low score
//     }
//
...
//         <button
//           onClick={handleNext}
//           className="flex items-center px-4 py-2 bg-[#EF7F1A] text-white rounded-md hover:bg-[#D06C15]"
//         >
//           {currentQuestionIndex === questions.length - 1 ? t('submit') : t('next')}
//           {currentQuestionIndex < questions.length - 1 && <ChevronRight size={20} className="ml-1" />}
//         </button>
